...
print('----------------------------')
print(f' {candidates[0]}     : {truncperlist[0]}% {valuelist[0]}')
print(f' {candidates[1]}   : {truncperlist[1]}% {valuelist[1]}')
print(f' {candidates[2]}       : {truncperlist[2]}% {valuelist[2]}')
print(f' {candidates[3]} : {truncperlist[3]}%  {valuelist[3]}')
print('----------------------------')
...
with open(output_path, "w") as text_file:
    ...
    print('----------------------------', file = text_file)
    print(f' {candidates[0]}     : {truncperlist[0]}% {valuelist[0]}', file = text_file)
    print(f' {candidates[1]}   : {truncperlist[1]}% {valuelist[1]}', file = text_file)
    print(f' {candidates[2]}       : {truncperlist[2]}% {valuelist[2]}',file = text_file)
    print(f' {candidates[3]} : {truncperlist[3]}%  {valuelist[3]}', file = text_file)
    print('----------------------------', file = text_file)
